    ...
    return (
      <div className={styles.container}>
        <div className={styles.errorContainer}>
          <h3>❌ Lỗi</h3>
          <p>{error}</p>
          <button className={styles.primaryButton} onClick={fetchOrders}>
            Thử lại
          </button>
        </div>
      </div>
  ...
  return (
    <div className={styles.container}>
              ...
              <tr key={order.id}>
                ...
                <td>
                  <div className={styles.customerInfo}>
                    <p className={styles.customerName}>{order.user?.fullName || 'Chưa cập nhật'}</p>
      ...
      <div className={styles.summary}>
        <p>
          Hiển thị <strong>{orders.length}</strong> / <strong>{totalOrders}</strong> đơn hàng
        </p>
      </div>
    </div>
  );
